...
def main():
  ...
  frm_main.master.title("Chemical formula calculator")
...
def get_gui(frm_main):
  ...
  lbl_formula = Label(frm_main, text="Enter the chemical formula")
  lbl_formula.grid(row=0, column=0, padx=3, pady=3)
  ent_formula = Entry(frm_main)
  ent_formula.grid(row=0, column=1)

  lbl_sample_mass = Label(frm_main, text="Enter the sample size in grams:")
  lbl_sample_mass.grid(row=1, column=0)
  ent_sample_mass = Entry(frm_main)
  ent_sample_mass.grid(row=1, column=1)
