...
def main():
    ...
    # There are the indexes of each elements in the inner lists.
    ...
    for inner_list in apple_tree_data:
        ...
        # Retrieve the fruit amount from the current inner list.
    ...
    print(f"The total fruit amount: {total_fruit_amount:.1f}")
